namespace FrogWinFormsApp
{
    public partial class MainForm : Form
    {
        ...
        {
            MessageBox.Show("Цель игры в том, чтобы расположить лягушек, которые смотрят влево, в левую часть, а остальных — в правую часть за минимальное количество перепрыгиваний. Прыгать можно на листок, если он находится рядом или через 1 лягушку.", "Правила");
        }
    }
}
