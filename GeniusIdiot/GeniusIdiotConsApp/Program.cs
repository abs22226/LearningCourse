...
namespace GeniusIdiotConsApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (userIsReady)
            {
                Console.WriteLine($"{user.Name}, начинаем новый квиз. У вас будет 10 секунд, чтобы ввести ответ, после чего, при отсутствии ответа, он будет засчитан как неверный, и появится следующий вопрос. Ввод должен быть числом от -2*10^9 до 2*10^9, иначе он не будет принят.");
